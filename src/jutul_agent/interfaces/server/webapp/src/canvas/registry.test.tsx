...
describe("stageGeometry", () => {
  ...
  it("scale never upscales past the figure's own size", () => {
    // A canvas grown by CSS blurs, so a panel larger than the figure centers it
    // 1:1, and the live-frame refit (kernel-side resize) is what then grows
    // the figure itself to the panel.
